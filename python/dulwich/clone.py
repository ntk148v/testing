...
Example usage:
  1. python clone.py git://github.com/jelmer/dulwich
  2. python clone.py git://github.com/jelmer/dulwich.git
  3. python clone.py git://github.com/jelmer/dulwich.git dulwich
  4. python clone.py https://github.com/jelmer/dulwich.git
"""
